...
alias dhrun='docker run --rm -it --net=host --user=$(id -u):$(id -g) --volume=/etc/group:/etc/group:ro --volume=/etc/passwd:/etc/passwd:ro --volume=/etc/shadow:/etc/shadow:ro -v=$HOME/x86_64_home:$HOME -v=/mnt:/mnt --workdir=$(pwd)'
